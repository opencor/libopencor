...
test.describe('Solver CVODE tests', () => {
  ...
  test('Solve', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [49.72583819278412, -0.1281928932150167, -0.05090363134799315, 0.09864930257002996],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
  ...
  test('Solve without interpolate solution', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [49.725708804678554, -0.12819363057965827, -0.05090307887503688, 0.09865054326613137],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
  ...
  test('Solve with Adams-Moulton integration method', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [49.72681387239589, -0.1281944327747464, -0.05090278303879249, 0.09865164422001499],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
  ...
  test('Solve with functional iteration type', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [49.725745713352005, -0.12819264218579152, -0.05090477732386291, 0.09864917810281565],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
  ...
  test('Solve with banded linear solver', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [47.19661058955666, -0.10208043809229013, -0.09297814175229392, 0.06297616024756474],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
  ...
  test('Solve with diagonal linear solver', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [49.72597399381498, -0.12819098846660215, -0.05090306558144843, 0.09865036279205125],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
  ...
  test('Solve with GMRES linear solver', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [-0.8640672736573222, 0.06435448572298622, 0.001717734101917398, -0.052716115419100616],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
  ...
  test('Solve with Bi-CGstab linear solver', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [-0.8640794299937041, 0.0643535850994105, 0.0017178663652530986, -0.052715357939910126],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
  ...
  test('Solve with TFQMR linear solver', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [-0.8641444918518275, 0.06434891303317661, 0.0017178076038649821, -0.05271146850152765],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
  ...
  test('Solve with GMRES linear solver and no preconditioner', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [49.725850793094246, -0.12819367339268917, -0.05090392373588483, 0.09865049266027853],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
  ...
  test('Solve with Bi-CGstab linear solver and no preconditioner', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [49.72555254907632, -0.12819286849323652, -0.05090358167883548, 0.09864924502317379],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
  ...
  test('Solve with TFQMR linear solver and no preconditioner', () => {
    ...
    odeModel.run(
      ...
      [7, 7, 7, 7],
      [49.72566119351199, -0.12819273665866548, -0.05090317673764379, 0.09864904013329096],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      [7, 7, 7, 7, 7],
      [-10.613, -115, 12],
