...
test.describe("Solver Forward Euler tests", () => {
  ...
  test("Solve", () => {
    ...
    odeModel.run(
      document,
      [
        -63.78772730984361, 0.13474847497254067, 0.9842548213064144,
        0.7411775397899872,
      ],
      [7, 7, 7, 7],
      [
        49.735769641933295, -0.12796285748502675, -0.051257421327489505,
        0.09833105129202639,
      ],
      [7, 7, 7, 7],
      [1, 0, 0.3, 120, 36],
      ...
      [7, 7, 7],
      [
        0, -15.952418192953083, -823.3611773703722, 789.5903038580858,
        3.9606641552180846, 0.11561746333925448, 0.002883800022109429,
        0.9670345037893372, 0.5403702607259088, 0.05631535007932083,
      ],
      [7, 7, 7, 7, 7, 7, 7, 7, 7, 7],
    );
