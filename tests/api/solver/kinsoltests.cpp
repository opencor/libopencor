...
{
    auto solver = std::static_pointer_cast<libOpenCOR::SolverOde>(libOpenCOR::Solver::create("KINSOL"));

    checkKinsolSolver(solver->info());
}

TEST(KinsolSolverTest, maximumStepValueWithNonNumber)
{
    // Create and initialise our various arrays and create our solver.

    const auto [solver, states, rates, variables] = createAndInitialiseArraysAndCreateSolver("KINSOL");
...
TEST(KinsolSolverTest, maximumStepValueWithInvalidNumber)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, maximumNumberOfStepsValueWithNonNumber)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, maximumNumberOfStepsValueWithInvalidNumber)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, integrationMethodValueWithUnknownValue)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, iterationTypeValueWithUnknownValue)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, preconditionerValueWithUnknownValue)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, gmresLinearSolverBandedPreconditionerAndUpperHalfBandwidthValueWithNumberTooSmall)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, gmresLinearSolverBandedPreconditionerAndUpperHalfBandwidthValueWithNumberTooBig)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, gmresLinearSolverBandedPreconditionerAndLowerHalfBandwidthValueWithNumberTooSmall)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, gmresLinearSolverBandedPreconditionerAndLowerHalfBandwidthValueWithNumberTooBig)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, relativeToleranceValueWithNonNumber)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, relativeToleranceValueWithInvalidNumber)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, absoluteToleranceValueWithNonNumber)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, absoluteToleranceValueWithInvalidNumber)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, interpolateSolutionValueWithNonBoolean)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, solveWithoutInterpolateSolution)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, solveWithAdamsMoultonIntegrationMethod)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, solveWithFunctionalIterationType)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, solveWithDiagonalLinearSolver)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, solveWithGmresLinearSolverAndNoPreconditioner)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, solveWithBicgstabLinearSolverAndNoPreconditioner)
{
    // Create and initialise our various arrays and create our solver.
...
TEST(KinsolSolverTest, solveWithTfqmrLinearSolverAndNoPreconditioner)
{
    // Create and initialise our various arrays and create our solver.
