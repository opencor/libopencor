...
find_program(COVERAGE_EXE NAMES ${PREFERRED_COVERAGE_NAMES} coverage)
...
if(PYTHON_UNIT_TESTING_AVAILABLE AND COVERAGE_EXE)
    set(PYTHON_CODE_COVERAGE_AVAILABLE TRUE)
else()
    set(PYTHON_CODE_COVERAGE_ERROR_MESSAGE "Python code coverage testing is requested but the coverage tool could not be found.")
endif()
