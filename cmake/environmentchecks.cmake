...
if(JAVASCRIPT_BINDINGS_AVAILABLE AND NODE_EXE AND NPM_EXE)
    set(JAVASCRIPT_CODE_COVERAGE_AVAILABLE TRUE)
else()
    set(JAVASCRIPT_CODE_COVERAGE_ERROR_MESSAGE "JavaScript code coverage is requested but the node and/or npm tools could not be found.")
endif()
...
if(PYTEST_EXE)
    check_python_package(pytest-cov PYTHON_PYTEST_COV_AVAILABLE)

    if(PYTHON_PYTEST_COV_AVAILABLE)
        set(PYTHON_CODE_COVERAGE_AVAILABLE TRUE)
    else()
        set(PYTHON_CODE_COVERAGE_ERROR_MESSAGE "Python code coverage is requested but the pytest-cov Python package could not be found.")
    endif()
endif()
