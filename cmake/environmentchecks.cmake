...
if(BUILDING_JAVASCRIPT_BINDINGS)
    ...
    if(EMCMAKE_EXE AND EMCONFIGURE_EXE)
        ...
        set(JAVASCRIPT_BINDINGS_ERROR_MESSAGE "JavaScript bindings are requested but the emcmake and emconfigure tools could not be found.")
        set(JAVASCRIPT_UNIT_TESTING_ERROR_MESSAGE "JavaScript unit testing is requested but the emcmake and emconfigure tools could not be found.")
    endif()
